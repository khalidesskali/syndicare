...
const SyndicLayout: React.FC<SyndicLayoutProps> = ({ children }) => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-green-50 to-slate-100">
      {/* Sidebar */}
      <SyndicSidebar isOpen={sidebarOpen} />
                ...
                <div className="hidden md:flex">
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-64 pl-10 pr-4 py-2 border border-slate-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent bg-slate-50"
                    />
                  </div>
                </div>
              </div>
              ...
              <div className="flex items-center space-x-4">
                ...
                <div className="relative">
                  ...
                  >
                    ...
                    <div className="h-10 w-10 bg-gradient-to-br from-green-600 to-green-700 rounded-full flex items-center justify-center text-white font-semibold">
                      {user?.first_name?.[0]}
                      {user?.last_name?.[0]}
                    </div>
